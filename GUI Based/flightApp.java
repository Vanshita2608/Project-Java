...
public class flightApp {
    ...
    JFrame frame = new JFrame("Air India");
    ...
    public void welcomeSection() {
        ...
        top.setText("****************************************");   
        middle.setText("*           Welcome to Air India         *");
        bottom.setText("****************************************");
    ...
    public void loginSection(String nav) {
        ...
        welcomeText.setText("Welcome to Air India");
    ...
    public void bookingSection() {
        ...
        JButton validate = new JButton("Next");
    ...
    public void promoSection() {
        ...
        paymentLabel.setText("Total payment is Rs" + c.calcTotal());
    ...
    public void paymentSection() {
        ...
        if(c.getPromo().equalsIgnoreCase("Superfly")) {
            ...
            paymentLabel.setText("Total price after disount is Rs" + c.calcDiscount());
        } else {
            
            paymentLabel.setText("Total price is Rs" + c.calcDiscount());
        }
