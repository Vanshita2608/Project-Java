...
public class Client extends User {
    ...
    public String saveReceipt() {
        ...
        String display = "";
        display = display + ("******************************\n");
        display = display + ("Air India Booking Receipt\n");
        display = display + ("******************************\n");
        ...
        display = display + ("Price:Rs" + getPrices() + "\n");
        ...
        display = display + ("******************************\n");
        display = display + ("Price: Rs" + calcTotal() + "\n");
        display = display + ("Price after discount:Rs" +  calcDiscount() + "\n");
        display = display + ("Payment:Rs" + getPayment() + "\n");
        display = display + ("Balance:Rs" + df.format(calcBalance()) + "\n");
        display = display + ("******************************\n");
    ...
    public String printReceipt() {
        ...
        String display = "<html>";
        display = display + ("******************************<br>");
        display = display + ("Air India Booking Receipt<br>");
        display = display + ("******************************<br>");
        ...
        display = display + ("Price:Rs" + getPrices() + "<br>");
        ...
        display = display + ("******************************<br>");
        display = display + ("Price: Rs" + calcTotal() + "<br>");
        display = display + ("Price after discount:Rs" +  calcDiscount() + "<br>");
        display = display + ("Payment:Rs" + getPayment() + "<br>");
        display = display + ("Balance:Rs" + df.format(calcBalance()) + "<br>");
        display = display + ("******************************<br>");
