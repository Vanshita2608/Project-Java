...
class DomesticPassengers
{
    ...
    int s,d,sts,date,age;
    String name ,gender ,email_id, pno;
...
{
    int s,d,sts,pno,age;
    String name,date ,gender ,email_id;
    ...
    {
 	  Scanner sc = new Scanner(System.in);     
       System.out.println("Enter the date you want to travel (DD/MM/YYYY)");
       date = sc.next();
...
class FlightReservation
{
    public static void main(String abc[]) throws Exception
    {
        ...
        System.out.println("\n\n\n                              Welcome to 'TOUCHING ADORABLE SKIES' Airline Booking                                   ");
        System.out.println("************************************************************************************************************************");
        ...
        else
        {
            ...
            switch(in)
            {
                ...
                case 5:
                {
                    ...
                    System.out.println("Departure : 23.33");
                    System.out.println("Arrival: 02.17");
                    System.out.println("Price : 62789");
            ...
            {
                iP[a] = new InternationalPassengers();
                iP[a].set_infoi();
            }
            for(int a = 0; a<numPassengers; a++)
            {
